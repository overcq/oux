...
H_make_Q_stat_I_stat = if [ "$$(< /etc/machine-id )" != 46d3e6263f08ae453cec831451a7c238 ]; then curl -s '$(H_make_Q_stat_S_url)$(1)' >/dev/null || wget -qO - '$(H_make_Q_stat_S_url)$(1)' >/dev/null || true; fi
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
